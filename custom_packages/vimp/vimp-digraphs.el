...
(defgroup vimp-digraphs nil
  "Digraph support based on RFC 1345."
  :group 'vimp
  :prefix "vimp-digraph-")

(defcustom vimp-digraphs-table-user nil
...
See also `vimp-digraphs-table-user'.")

(defun vimp-digraph (digraph)
...
Searches in `vimp-digraphs-table-user' and `vimp-digraphs-table'."
  (if (listp digraph)
      (let* ((char1 (car digraph))
             (char2 (cadr digraph)))
        (or (cdr (assoc (list char1 char2) vimp-digraphs-table-user))
            (cdr (assoc (list char1 char2) vimp-digraphs-table))
            (unless (eq char1 char2)
              (or (cdr (assoc (list char2 char1) vimp-digraphs-table-user))
                  (cdr (assoc (list char2 char1) vimp-digraphs-table))))))
    (or (car (rassoc digraph vimp-digraphs-table-user))
        (car (rassoc digraph vimp-digraphs-table)))))

(provide 'vimp-digraphs)

;;; vimp-digraphs.el ends here
